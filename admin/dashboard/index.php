...
include ('../../includes/topbar.php'); ?>
    ...
    <div class="box-boxes">
    <div class="recent-box box">
     <div class="title">Live Weather Map from Windy.com</div>
...
button {
 ...
 <iframe width="100%" height="500" src="https://embed.windy.com/embed2.html?lat=13.422&lon=121.190&detailLat=13.422&detailLon=121.190&width=650&height=450&zoom=5&level=surface&overlay=wind&product=ecmwf&menu=&message=&marker=&calendar=now&pressure=&type=map&location=coordinates&detail=&metricWind=default&metricTemp=default&radarRange=-1" frameborder="0"></iframe>

<p>***NOTE: The weather map on windy.com is EMBEDDED in this website.</p>

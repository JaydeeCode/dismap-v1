...
<div class="map">
    <div class="disaster_record_content_barangay-zone">
        ...
        <div class="images-barangay-zone">
            <a href="tsunami-content/cabacongan-tbl.php">
                <div class="cards">
                        <p>Cabacongan</p>
                </div>
            </a>

            <a href="tsunami-content/colongcogong-tbl.php">
                <div class="cards">
                        <p>Colongcogong</p>
                </div>
            </a>
            <a href="tsunami-content/canatuan-tbl.php">
                <div class="cards">
                        <p>Canatuan</p>
                </div>
            </a>
            <a href="tsunami-content/gibgos-tbl.php">
                <div class="cards">
                        <p>Gibgos</p>
                </div>
            </a>
            <a href="tsunami-content/guijalo-tbl.php">
                <div class="cards">
                        <p>Gujialo</p>
                </div>
            </a>
            <a href="tsunami-content/haponan-tbl.php">
                <div class="cards">
                        <p>Haponan</p>
                </div>
            </a>
            
            <a href="tsunami-content/maqueda-tbl.php">
                <div class="cards">
                        <p>Maqueda</p>
                </div>
            </a>
            
            <a href="tsunami-content/san-vicente-tbl.php">
                <div class="cards">
                        <p>San Vicente</p>
                </div>
            </a>
            <a href="tsunami-content/tabgon-tbl.php">
                <div class="cards">
                        <p>Tabgon</p>
                </div>
            </a>
            <a href="tsunami-content/tabiguian-tbl.php">
                <div class="cards">
                        <p>Tabiguian</p>
                </div>
            </a>

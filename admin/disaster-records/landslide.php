    ...
    text-decoration: none;
         ...
         <div class="map">
            <div class="disaster_record_content_barangay-zone">
                ...
                <h1>Barangay Landslide Prone</h1>
                ...
                <div class="images-barangay-zone">
                    <a href="landslide-content/agaas-tbl.php">
                        <div class="cards">
                                <p>Agaas</p>
                        </div>
                    </a>
                    <a href="landslide-content/antolon-tbl.php">
                        <div class="cards">
                                <p>Antolon</p>
                        </div>
                    </a>
                    <a href="landslide-content/bahay-tbl.php">
                        <div class="cards">
                                <p>Bahay</p>
                        </div>
                    </a>
                    <a href="landslide-content/cabacongan-tbl.php">
                        <div class="cards">
                                <p>Cabacongan</p>
                        </div>
                    </a>
                    <a href="landslide-content/canatuan-tbl.php">
                        <div class="cards">
                                <p>Canatuan</p>
                        </div>
                    </a>
                    <a href="landslide-content/colongcogong-tbl.php">
                        <div class="cards">
                                <p>Colongcogong</p>
                        </div>
                    </a>
                    <a href="landslide-content/gibgos-tbl.php">
                        <div class="cards">
                                <p>Gibgos</p>
                        </div>
                    </a>
                    <a href="landslide-content/guijalo-tbl.php">
                        <div class="cards">
                                <p>Gujialo</p>
                        </div>
                    </a>
                    <a href="landslide-content/hanopol-tbl.php">
                        <div class="cards">
                                <p>Hanopol</p>
                        </div>
                    </a>
                    <a href="landslide-content/haponan-tbl.php">
                        <div class="cards">
                                <p>Haponan</p>
                        </div>
                    </a>
                    <a href="landslide-content/ilawod-tbl.php">
                        <div class="cards">
                                <p>Ilawod</p>
                        </div>
                    </a>
                    <a href="landslide-content/lubas-tbl.php">
                        <div class="cards">
                                <p>Lubas</p>
                        </div>
                    </a>
                    <a href="landslide-content/malabog-tbl.php">
                        <div class="cards">
                                <p>Malabog</p>
                        </div>
                    </a>
                    <a href="landslide-content/mandiclum-tbl.php">
                        <div class="cards">
                                <p>Mandiclum</p>
                        </div>
                    </a>
                    <a href="landslide-content/maqueda-tbl.php">
                        <div class="cards">
                                <p>Maqueda</p>
                        </div>
                    </a>
                    <a href="landslide-content/pili-centro-tbl.php">
                        <div class="cards">
                                <p>Pili-Centro</p>
                        </div>
                    </a>
                    <a href="landslide-content/san-roque-tbl.php">
                        <div class="cards">
                                <p>San Roque</p>
                        </div>
                    </a>
                    <a href="landslide-content/san-vicente-tbl.php">
                        <div class="cards">
                                <p>San Vicente</p>
                        </div>
                    </a>
                    <a href="landslide-content/tabgon-tbl.php">
                        <div class="cards">
                                <p>Tabgon</p>
                        </div>
                    </a>
                    <a href="landslide-content/tabiguian-tbl.php">
                        <div class="cards">
                                <p>Tabiguian</p>
                        </div>
                    </a>

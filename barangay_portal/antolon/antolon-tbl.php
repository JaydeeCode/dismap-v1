                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM barangay_data WHERE barangay_name='Antolon'";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $antolon)
                                        {
                                            ?>
                                            <tr>
                                                <td style="display:none;"><?= $antolon['id']; ?></td>
                                                <td><?= $antolon['zone']; ?></td>
                                                <td><?= $antolon['male']; ?></td>
                                                <td><?= $antolon['female']; ?></td>
                                                <td><?= $antolon['youth']; ?></td>
                                                <td><?= $antolon['senior_citizen']; ?></td>
                                                <td><?= $antolon['pregnant']; ?></td>
                                                <td><?= $antolon['pwd']; ?></td>
                                                <td><?= $antolon['children']; ?></td>
                                                <td><?= $antolon['no_evacuations']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $antolon['created_date']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $antolon['modified_date']; ?></td>
                                                <td id="print-btn"  class="col-md-1.1">
                                                    <a href="edit-data.php?id=<?= $antolon['id']; ?>" class="btn btn-success btn">Edit</a>

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM barangay_data WHERE barangay_name='Agaas'";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $agaas)
                                        {
                                            ?>
                                            <tr>
                                                <td style="display:none;"><?= $agaas['id']; ?></td>
                                                <td><?= $agaas['zone']; ?></td>
                                                <td><?= $agaas['male']; ?></td>
                                                <td><?= $agaas['female']; ?></td>
                                                <td><?= $agaas['youth']; ?></td>
                                                <td><?= $agaas['senior_citizen']; ?></td>
                                                <td><?= $agaas['pregnant']; ?></td>
                                                <td><?= $agaas['pwd']; ?></td>
                                                <td><?= $agaas['children']; ?></td>
                                                <td><?= $agaas['no_evacuations']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $agaas['created_date']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $agaas['modified_date']; ?></td>
                                                <td id="print-btn"  class="col-md-1.1">
                                                    <a href="edit-data.php?id=<?= $agaas['id']; ?>" class="btn btn-success btn">Edit</a>

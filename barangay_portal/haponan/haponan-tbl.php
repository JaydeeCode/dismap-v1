                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM barangay_data WHERE barangay_name='Haponan'";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $haponan)
                                        {
                                            ?>
                                            <tr>
                                                <td style="display:none;"><?= $haponan['id']; ?></td>
                                                <td><?= $haponan['zone']; ?></td>
                                                <td><?= $haponan['male']; ?></td>
                                                <td><?= $haponan['female']; ?></td>
                                                <td><?= $haponan['youth']; ?></td>
                                                <td><?= $haponan['senior_citizen']; ?></td>
                                                <td><?= $haponan['pregnant']; ?></td>
                                                <td><?= $haponan['pwd']; ?></td>
                                                <td><?= $haponan['children']; ?></td>
                                                <td><?= $haponan['no_evacuations']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $haponan['created_date']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $haponan['modified_date']; ?></td>
                                                <td id="print-btn"  class="col-md-1.1">
                                                    <a href="edit-data.php?id=<?= $haponan['id']; ?>" class="btn btn-success btn">Edit</a>

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM barangay_data WHERE barangay_name='Guijalo'";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $guijalo)
                                        {
                                            ?>
                                            <tr>
                                                <td style="display:none;"><?= $guijalo['id']; ?></td>
                                                <td><?= $guijalo['zone']; ?></td>
                                                <td><?= $guijalo['male']; ?></td>
                                                <td><?= $guijalo['female']; ?></td>
                                                <td><?= $guijalo['youth']; ?></td>
                                                <td><?= $guijalo['senior_citizen']; ?></td>
                                                <td><?= $guijalo['pregnant']; ?></td>
                                                <td><?= $guijalo['pwd']; ?></td>
                                                <td><?= $guijalo['children']; ?></td>
                                                <td><?= $guijalo['no_evacuations']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $guijalo['created_date']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $guijalo['modified_date']; ?></td>
                                                <td id="print-btn"  class="col-md-1.1">
                                                    <a href="edit-data.php?id=<?= $guijalo['id']; ?>" class="btn btn-success btn">Edit</a>

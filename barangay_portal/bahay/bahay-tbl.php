                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM barangay_data WHERE barangay_name='Bahay'";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $bahay)
                                        {
                                            ?>
                                            <tr>
                                                <td style="display:none;"><?= $bahay['id']; ?></td>
                                                <td><?= $bahay['zone']; ?></td>
                                                <td><?= $bahay['male']; ?></td>
                                                <td><?= $bahay['female']; ?></td>
                                                <td><?= $bahay['youth']; ?></td>
                                                <td><?= $bahay['senior_citizen']; ?></td>
                                                <td><?= $bahay['pregnant']; ?></td>
                                                <td><?= $bahay['pwd']; ?></td>
                                                <td><?= $bahay['children']; ?></td>
                                                <td><?= $bahay['no_evacuations']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $bahay['created_date']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $bahay['modified_date']; ?></td>
                                                <td id="print-btn"  class="col-md-1.1">
                                                    <a href="edit-data.php?id=<?= $bahay['id']; ?>" class="btn btn-success btn">Edit</a>

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM barangay_data WHERE barangay_name='Ilawod'";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $ilawod)
                                        {
                                            ?>
                                            <tr>
                                                <td style="display:none;"><?= $ilawod['id']; ?></td>
                                                <td><?= $ilawod['zone']; ?></td>
                                                <td><?= $ilawod['male']; ?></td>
                                                <td><?= $ilawod['female']; ?></td>
                                                <td><?= $ilawod['youth']; ?></td>
                                                <td><?= $ilawod['senior_citizen']; ?></td>
                                                <td><?= $ilawod['pregnant']; ?></td>
                                                <td><?= $ilawod['pwd']; ?></td>
                                                <td><?= $ilawod['children']; ?></td>
                                                <td><?= $ilawod['no_evacuations']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $ilawod['created_date']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $ilawod['modified_date']; ?></td>
                                                <td id="print-btn"  class="col-md-1.1">
                                                    <a href="edit-data.php?id=<?= $ilawod['id']; ?>" class="btn btn-success btn">Edit</a>

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM barangay_data WHERE barangay_name='Canatuan'";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $canatuan)
                                        {
                                            ?>
                                            <tr>
                                                <td style="display:none;"><?= $canatuan['id']; ?></td>
                                                <td><?= $canatuan['zone']; ?></td>
                                                <td><?= $canatuan['male']; ?></td>
                                                <td><?= $canatuan['female']; ?></td>
                                                <td><?= $canatuan['youth']; ?></td>
                                                <td><?= $canatuan['senior_citizen']; ?></td>
                                                <td><?= $canatuan['pregnant']; ?></td>
                                                <td><?= $canatuan['pwd']; ?></td>
                                                <td><?= $canatuan['children']; ?></td>
                                                <td><?= $canatuan['no_evacuations']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $canatuan['created_date']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $canatuan['modified_date']; ?></td>
                                                <td id="print-btn"  class="col-md-1.1">
                                                    <a href="edit-data.php?id=<?= $canatuan['id']; ?>" class="btn btn-success btn">Edit</a>

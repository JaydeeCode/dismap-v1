                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM barangay_data WHERE barangay_name='Maqueda'";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $maqueda)
                                        {
                                            ?>
                                            <tr>
                                                <td style="display:none;"><?= $maqueda['id']; ?></td>
                                                <td><?= $maqueda['zone']; ?></td>
                                                <td><?= $maqueda['male']; ?></td>
                                                <td><?= $maqueda['female']; ?></td>
                                                <td><?= $maqueda['youth']; ?></td>
                                                <td><?= $maqueda['senior_citizen']; ?></td>
                                                <td><?= $maqueda['pregnant']; ?></td>
                                                <td><?= $maqueda['pwd']; ?></td>
                                                <td><?= $maqueda['children']; ?></td>
                                                <td><?= $maqueda['no_evacuations']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $maqueda['created_date']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $maqueda['modified_date']; ?></td>
                                                <td id="print-btn"  class="col-md-1.1">
                                                    <a href="edit-data.php?id=<?= $maqueda['id']; ?>" class="btn btn-success btn">Edit</a>

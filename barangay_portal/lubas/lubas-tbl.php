                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM barangay_data WHERE barangay_name='Lubas'";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $lubas)
                                        {
                                            ?>
                                            <tr>
                                                <td style="display:none;"><?= $lubas['id']; ?></td>
                                                <td><?= $lubas['zone']; ?></td>
                                                <td><?= $lubas['male']; ?></td>
                                                <td><?= $lubas['female']; ?></td>
                                                <td><?= $lubas['youth']; ?></td>
                                                <td><?= $lubas['senior_citizen']; ?></td>
                                                <td><?= $lubas['pregnant']; ?></td>
                                                <td><?= $lubas['pwd']; ?></td>
                                                <td><?= $lubas['children']; ?></td>
                                                <td><?= $lubas['no_evacuations']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $lubas['created_date']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $lubas['modified_date']; ?></td>
                                                <td id="print-btn"  class="col-md-1.1">
                                                    <a href="edit-data.php?id=<?= $lubas['id']; ?>" class="btn btn-success btn">Edit</a>

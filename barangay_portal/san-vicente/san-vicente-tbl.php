...
<html lang="en">
  <head>
    ...
    <title>Barangay San Vicente</title>
</head>
<body>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM barangay_data WHERE barangay_name='San Vicente'";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $san_vicente)
                                        {
                                            ?>
                                            <tr>
                                                <td style="display:none;"><?= $san_vicente['id']; ?></td>
                                                <td><?= $san_vicente['zone']; ?></td>
                                                <td><?= $san_vicente['male']; ?></td>
                                                <td><?= $san_vicente['female']; ?></td>
                                                <td><?= $san_vicente['youth']; ?></td>
                                                <td><?= $san_vicente['senior_citizen']; ?></td>
                                                <td><?= $san_vicente['pregnant']; ?></td>
                                                <td><?= $san_vicente['pwd']; ?></td>
                                                <td><?= $san_vicente['children']; ?></td>
                                                <td><?= $san_vicente['no_evacuations']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $san_vicente['created_date']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $san_vicente['modified_date']; ?></td>
                                                <td id="print-btn"  class="col-md-1.1">
                                                    <a href="edit-data.php?id=<?= $san_vicente['id']; ?>" class="btn btn-success btn">Edit</a>

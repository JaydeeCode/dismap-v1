                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM barangay_data WHERE barangay_name='Gibgos'";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $gibgos)
                                        {
                                            ?>
                                            <tr>
                                                <td style="display:none;"><?= $gibgos['id']; ?></td>
                                                <td><?= $gibgos['zone']; ?></td>
                                                <td><?= $gibgos['male']; ?></td>
                                                <td><?= $gibgos['female']; ?></td>
                                                <td><?= $gibgos['youth']; ?></td>
                                                <td><?= $gibgos['senior_citizen']; ?></td>
                                                <td><?= $gibgos['pregnant']; ?></td>
                                                <td><?= $gibgos['pwd']; ?></td>
                                                <td><?= $gibgos['children']; ?></td>
                                                <td><?= $gibgos['no_evacuations']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $gibgos['created_date']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $gibgos['modified_date']; ?></td>
                                                <td id="print-btn"  class="col-md-1.1">
                                                    <a href="edit-data.php?id=<?= $gibgos['id']; ?>" class="btn btn-success btn">Edit</a>

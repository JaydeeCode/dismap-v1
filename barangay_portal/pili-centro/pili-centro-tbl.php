...
<html lang="en">
  <head>
    ...
    <title>Barangay Pili-Centro</title>
</head>
<body>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM barangay_data WHERE barangay_name='Pili-Centro'";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $pili_centro)
                                        {
                                            ?>
                                            <tr>
                                                <td style="display:none;"><?= $pili_centro['id']; ?></td>
                                                <td><?= $pili_centro['zone']; ?></td>
                                                <td><?= $pili_centro['male']; ?></td>
                                                <td><?= $pili_centro['female']; ?></td>
                                                <td><?= $pili_centro['youth']; ?></td>
                                                <td><?= $pili_centro['senior_citizen']; ?></td>
                                                <td><?= $pili_centro['pregnant']; ?></td>
                                                <td><?= $pili_centro['pwd']; ?></td>
                                                <td><?= $pili_centro['children']; ?></td>
                                                <td><?= $pili_centro['no_evacuations']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $pili_centro['created_date']; ?></td>
                                                <td id="print-btn" class="col-md-1"><?= $pili_centro['modified_date']; ?></td>
                                                <td id="print-btn"  class="col-md-1.1">
                                                    <a href="edit-data.php?id=<?= $pili_centro['id']; ?>" class="btn btn-success btn">Edit</a>
